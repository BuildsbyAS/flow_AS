...
// Selected day fills with the warm-brown brand color (#3D1602) to match the
// rest of the page — hover stays as WARM_HOVER cream.
const CALENDAR_SELECTED_BG = '#3D1602';
const CALENDAR_SELECTED_FG = '#FFFFFF';
...
function CalendarDay({ day, isSel, isToday, onClick }) {
  ...
  const bg = isSel
    ...
    : hover
      ? WARM_HOVER
      : 'transparent';
  const fg = isSel ? CALENDAR_SELECTED_FG : 'var(--c-text-primary)';
  return (
    <button
      type="button"
      onClick={onClick}
