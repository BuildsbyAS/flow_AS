    ...
    <section>
      ...
      >
        ...
        >
          ...
          <MonthGrid totalWeeks={totalWeeks} />
  ...
  return (
    <div
      ...
      style={{
        ...
        inset: 0,
        display: 'grid',
        gridTemplateColumns: mockMonths.map(() => '1fr').join(' '),
        background:
    ...
    >
      {mockMonths.map((m, i) => (
        <div
          key={m.key}
          style={{
            borderRight: i < mockMonths.length - 1 ? '1px solid var(--c-border-primary)' : 'none',
          }}
        />
      ))}
    </div>
